# Test cases for validation and authentication functions.

# Imports
from database import DatabaseManager
from models import Student, Team, Project, Faculty
from validation import check_team_size, check_specialization, check_prerequisites, check_slots, check_supervisor,validate_registration
...
ok, msg = validate_registration(valid_team, valid_project, valid_faculty, db, project_id, team_id)
